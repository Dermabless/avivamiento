        ...
        <div class="row">
          <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Edit Video Details</li>
              </ol>
            </nav>
          </div>
        ...
        <form id="upload-form">
              ...
              <div class="form-line">
                ...
                <select class="form-control" id="branch">
                  <?php foreach ($branches as $res) { ?>
                    <option value="<?php echo $res->id; ?>" <?php echo $video->branch==$res->id?"selected":""; ?>><?php echo $res->name; ?></option>
                  <?php  } ?>
                </select>
              </div>
          </div>
          ...
          <div id="link_div" style="margin-top:20px; display:none;">
            ...
            <div class="form-group" style="margin-top:20px;">
                ...
                <div class="form-line">
                    <input type="url" class="form-control" id="media_link" placeholder="Audio File Link" autofocus="" value="<?php echo $video->source; ?>">
                </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              <label>Video Duration (format 00:00:00)</label>
              <div class="form-line">
            ...
            <input type="hidden" required="" id="id" autofocus="" value="<?php echo $video->id; ?>">
