          ...
          <div class="form-group" style="margin-top:20px;">
              <div class="form-line">
                ...
                <select class="form-control" name="prefered_gateway">
                 <option value="flutterwaves" <?php if($settings->prefered_gateway == "flutterwaves"){ echo "selected"; } ?>>Flutterwaves</option>
                 <option value="paystack" <?php if($settings->prefered_gateway == "paystack"){ echo "selected"; } ?>>Paystack</option>
                </select>
              </div>
          </div>
          <div class="form-group" style="margin-top:20px;">
