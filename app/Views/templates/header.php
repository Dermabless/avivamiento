...
<body>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="">
				<h4 style="color:white;">Avivamiento</h4>
			</a>
		...
		<div class="menu-block customscroll">
          ...
          <li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="<?php echo base_url(); ?>/videos" <?php if (strpos(strtolower($url),'video') !== false){ ?> class="active" <?php } ?>>Videos</a></li>
							<li><a href="<?php echo base_url(); ?>/audios" <?php if (strpos(strtolower($url),'audio') !== false){ ?> class="active" <?php } ?>>Audios</a></li>
							<li><a href="<?php echo base_url(); ?>/livestreams" <?php if (strpos(strtolower($url),'livestream') !== false){ ?> class="active" <?php } ?>>Livestream</a></li>
							<li><a href="<?php echo base_url(); ?>/radio" <?php if (strpos(strtolower($url),'radio') !== false){ ?> class="active" <?php } ?>>Radio</a></li>
							<li><a href="<?php echo base_url(); ?>/photos" <?php if (strpos(strtolower($url),'photo') !== false){ ?> class="active" <?php } ?>>Photos</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-books"></span><span class="mtext">Publications</span>
						</a>
						<ul class="submenu">
          ...
          <li>
						<a href="<?php echo base_url(); ?>/branchesListing" class="dropdown-toggle no-arrow <?php if (strpos(strtolower($url),'branch') !== false){ ?> active <?php } ?>" >
							<span class="micon dw dw-city"></span><span class="mtext">Locations</span>
						</a>
					</li>
				<?php } ?>
          <li>
