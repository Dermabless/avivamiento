                  ...
                  <td class="text-center">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a data-type="book" data-id="<?php echo $record->id; ?>" class="dropdown-item" onclick="delete_item(event)">
                        <i data-type="book" data-id="<?php echo $record->id; ?>" class="dw dw-delete-3"></i> Delete</a>
                      </div>
                    </div>
                  </td>
                 </tr>
