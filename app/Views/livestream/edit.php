    ...
    <div class="min-height-200px">
        ...
        <div class="row">
          <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Edit Livestream</li>
              </ol>
            </nav>
          </div>
      ...
      <div class="pd-20 card-box mb-30">
        ...
        <form method="POST" action="<?php echo base_url(); ?>/editLivestreamData" enctype="multipart/form-data" style="margin-top:30px;">
          <input type="hidden" class="form-control" name="id" placeholder="Branch Name" required="" autofocus="" value="<?php echo $livestream->id; ?>">
              ...
              <div class="form-line">
                ...
                <select class="form-control" name="branch">
                  <?php foreach ($branches as $res) { ?>
                    <option value="<?php echo $res->id; ?>" <?php echo $livestream->branch==$res->id?"selected":""; ?>><?php echo $res->name; ?></option>
                  <?php  } ?>
                </select>
              </div>
          </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                  <input type="text" class="form-control" name="title" placeholder="Livestream Title" required="" autofocus="" value="<?php echo $livestream->title; ?>">
              </div>
          </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                  <input type="text" class="form-control" value="<?php echo $livestream->description; ?>" name="description" placeholder="Livestream Description" required="" autofocus="" required>
              </div>
          </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                  <input type="text" class="form-control" name="link" value="<?php echo $livestream->link; ?>" placeholder="Livestream Link" required="" autofocus="">
              </div>
          </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              <div class="form-line">
                ...
                <select class="form-control" name="status" required="" autofocus="">
                  <option value="0" <?php echo $livestream->status==0?"selected":""; ?>>Live</option>
                  <option value="1" <?php echo $livestream->status==1?"selected":""; ?>>Not Live</option>
                </select>
              </div>
          </div>
          ...
          <div class="box-footer text-center">
             <button class="btn btn-primary waves-effect" type="submit">Update Livestream</button>
          </div>
