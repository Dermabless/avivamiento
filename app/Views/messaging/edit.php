        ...
        <form method="POST" action="<?php echo base_url(); ?>/sendnewmessage" enctype="multipart/form-data" style="margin-top:30px;">
         ...
         <div id="smsgatewaydiv" class="form-group" <?php if($istwilioenabled==1 && $istermiienabled == 1){ ?> style="display:none;" <?php } ?>>
          ...
          <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                  <input type="text" class="form-control" name="title" placeholder="Message Title" required="" autofocus="" value="<?php echo $message->title; ?>">
              </div>
          </div>
          ...
          <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                  <textarea type="text" class="form-control" name="message" placeholder="Message content" required="" autofocus="" required><?php echo $message->message; ?></textarea>
              </div>
          </div>
